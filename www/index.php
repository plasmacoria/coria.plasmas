	...
	<div id="contain">
		...
		<!-- Actualités ... -->
			...
			<div id="actualites">
				<div id="img_actualites"></div>
				    ...
				    {          // tant que le ">" est bien derrière "<" 
				        $texte_debut = substr($texte, 0, $position1);  // $texte du début jusqu'à "<"
				        $position2+=2;
				        $texte_fin = substr($texte, $position2);            // $texte de ">" jusqu'à la fin de chaine
				        $texte = $texte_debut.$texte_fin;                    // concaténation des deux chaines (debut et fin)
				        $position1 = strpos($texte, "<img");    // position du "<"     // rÈ-initialisation du $position1 et $position2 pour savoir si on quitte la boucle (s'il y a une autre image, dans le texte, ‡ supprimer)
				        $position2 = strpos($texte, "/>");   // position du ">"
				    }
		...
		<div id="slideshow">
			...
			<ul id="mycarousel" class="jcarousel-skin-tango">
					...
					<li>
					<a href="http://www.youtube.com/watch?v=vSeZ048m0ks&feature=youtu.be" rel="vidbox" title="Gazeification Explications"><img src="img/slide/gaz_explications.png" width="75" height="75" alt="Gazéification Explications" /></a></li>
					<li>
					<a href="http://www.youtube.com/watch?v=FmsR-wb0Cjk&feature=youtu.be" rel="vidbox" title="..."><img src="img/slide/thermo_etude_phenome.png" width="75" height="75" alt="fusion thermonucleaire - Explication du phénomène" /></a></li>
					</li>
					<li>
